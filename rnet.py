...
def main():
    if "--silent" not in sys.argv:
        print "                                                                                                                   "
		print "                                                                                                                   "
		print "                          (((((( NNNNNNNN        NNNNNNNNEEEEEEEEEEEEEEEEEEEEEETTTTTTTTTTTTTTTTTTTTTTT ))))))      "
		print "                        ((::::::(N:::::::N       N::::::NE::::::::::::::::::::ET:::::::::::::::::::::T)::::::))    "
		print "                      ((:::::::( N::::::::N      N::::::NE::::::::::::::::::::ET:::::::::::::::::::::T ):::::::))  "
		print "                     (:::::::((  N:::::::::N     N::::::NEE::::::EEEEEEEEE::::ET:::::TT:::::::TT:::::T  )):::::::) "
		print " rrrrr   rrrrrrrrr   (::::::(    N::::::::::N    N::::::N  E:::::E       EEEEEETTTTTT  T:::::T  TTTTTT    )::::::) "
		print " r::::rrr:::::::::r  (:::::(     N:::::::::::N   N::::::N  E:::::E                     T:::::T             ):::::) "
		print " r:::::::::::::::::r (:::::(     N:::::::N::::N  N::::::N  E::::::EEEEEEEEEE           T:::::T             ):::::) "
		print " rr::::::rrrrr::::::r(:::::(     N::::::N N::::N N::::::N  E:::::::::::::::E           T:::::T             ):::::) "
		print "  r:::::r     r:::::r(:::::(     N::::::N  N::::N:::::::N  E:::::::::::::::E           T:::::T             ):::::) "
		print "  r:::::r     rrrrrrr(:::::(     N::::::N   N:::::::::::N  E::::::EEEEEEEEEE           T:::::T             ):::::) "
		print "  r:::::r            (:::::(     N::::::N    N::::::::::N  E:::::E                     T:::::T             ):::::) "
		print "  r:::::r            (::::::(    N::::::N     N:::::::::N  E:::::E       EEEEEE        T:::::T            )::::::) "
		print "  r:::::r            (:::::::((  N::::::N      N::::::::NEE::::::EEEEEEEE:::::E      TT:::::::TT        )):::::::) "
		print "  r:::::r             ((:::::::( N::::::N       N:::::::NE::::::::::::::::::::E      T:::::::::T       ):::::::))  "
		print "  r:::::r               ((::::::(N::::::N        N::::::NE::::::::::::::::::::E      T:::::::::T      )::::::)     "
		print "  rrrrrrr                 (((((( NNNNNNNN         NNNNNNNEEEEEEEEEEEEEEEEEEEEEE      TTTTTTTTTTT       ))))))      "
		print "  ---------------------------------------------------------------------------------------------------------------  "
		print "  |                      A decentralize P2P private network based on blockchain technology!                     |  "
		print "  ---------------------------------------------------------------------------------------------------------------  "
		print "     +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++     "
		print "         +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++         "
		print "             +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++             "
    ...
    try:
        ...
        os.chdir(app_dir)  # Change working dir to rnet.py dir
