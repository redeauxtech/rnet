...
update_after_shutdown = False  # If set True then update and restart r(NET) after main loop ended
...
if config.action == "main":
    ...
    try:
        ...
        print "Can't open lock file, your r(NET) client is probably already running, exiting... (%s)" % err
...
actions = Actions()
# Starts here when running rnet.py
